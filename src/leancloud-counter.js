 ...
 * 基于LeanCloud的无后端访问统计
 * @version 1.0.0
 * @author Qin, YuanPei [qinyuanpei@163.com]
 * @copyright Qin, YuanPei 2014-2017
 * @license MIT
 **/
function VisitorCounter() {
    ...
    this.queryClass = function (className, where) {
        ...
        var url = this.config.baseUrl + '/1.1/classes/' + className + '?where=' + JSON.stringify(where);
        return fetch(url, {
            mode: 'cors',
            method: 'GET',
            headers: headers,
    ...
    this.createClass = function (className, obj) {
        var headers = this.buildHeaders();
        var url = this.config.baseUrl + '/1.1/classes/' + className;
        return fetch(url, {
            mode: 'cors',
            method: 'POST',
            headers: headers,
    ...
    this.updateClass = function (className, obj) {
        var headers = this.buildHeaders();
        var url = this.config.baseUrl + '/1.1/classes/' + className + '/' + obj.objectId;
        return fetch(url, {
            mode: 'cors',
            method: 'PUT',
            headers: headers,
